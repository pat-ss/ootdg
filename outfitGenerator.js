    ...
    if(document.getElementById("ignoreRules").checked == true){
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                document.getElementById("generateImages").style.display = "inline-block";
...
function generateImages(ids){
    ...
    $.ajax({
        ...
        success: function(result){
            ...
            console.log(result);
            document.getElementById("imagesGoHere").innerHTML = result;
            document.getElementById("generateImages").style.display = "inline-block";
...
function startTime() {
    ...
    m = checkTime(m);
    s = checkTime(s);
    document.getElementById('txt').innerHTML = d + "," + " " + month + " " + day;
